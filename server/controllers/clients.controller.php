<?php
                ...
                if (isset($_GET[$clients->table."-new"])) {
                    ...
                    notification("Bienvenu sur JEB systeme ".$_POST["nom"],"Nous somme heureux de vous compter parmi nous !","/?apps/profile/user.html","",[$id],$notifications,$notifications_store);
                    $admins=[];
